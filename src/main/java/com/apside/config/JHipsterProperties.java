...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "cvtheque@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "cvtheque API";

        private String description = "cvtheque API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "cvtheque";
