...
class ExperienceGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Experience entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "intitule":"SAMPLE_TEXT", "datedebut":"2020-01-01T00:00:00.000Z", "datefin":"2020-01-01T00:00:00.000Z", "entreprise":"SAMPLE_TEXT", "description":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
